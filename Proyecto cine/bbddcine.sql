...
--
-- Servidor: localhost
-- Tiempo de generación: 31-05-2017 a las 07:29:43
...
INSERT INTO `alumnos` (`nombre`, `dni`, `telefono`, `direccion`, `matricula`, `curso`, `FechaMatricula`) VALUES
('Ana López Sanz', '11111111A', '677876543', '', 1001, 'DAW1', '0000-00-00'),
('Luis Pérez Rodríguez', '22222222B', '677889988', '', 1002, 'ASIR1', '0000-00-00'),
('Juan López López', '44444444D', '655443322', '', 1003, 'DAW1', '0000-00-00');
...
--
CREATE DATABASE `bbddcine` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `bbddcine`;
...
('def', 'agenda', 'alumnos', 'nombre', 1, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'dni', 2, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(9)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'telefono', 3, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(9)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'direccion', 4, NULL, 'NO', 'varchar', 25, 75, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'matricula', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'curso', 6, NULL, 'NO', 'varchar', 8, 24, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(8)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'agenda', 'alumnos', 'FechaMatricula', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'contactos', 'nombre', 1, NULL, 'NO', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'contactos', 'apellidos', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'contactos', 'telefono', 3, NULL, 'NO', 'varchar', 11, 33, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'agenda', 'cursos', 'curso', 1, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'agenda', 'cursos', 'descripcion', 2, NULL, 'NO', 'varchar', 80, 240, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(80)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'cursos', 'aula', 3, NULL, 'NO', 'varchar', 5, 15, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(5)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'tutores', 'dni', 1, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(9)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'agenda', 'tutores', 'nombre', 2, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'agenda', 'tutores', 'curso', 3, NULL, 'YES', 'varchar', 8, 24, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(8)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'CodCliente', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Nombre', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Apellidos', 3, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'DNI', 4, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Telefono', 5, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Correo', 6, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'FechaNacimiento', 7, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'NumTarjeta', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Descuento', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'cliente', 'Clave', 10, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'compras', 'CodCompra', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'compras', 'CodCliente', 2, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'compras', 'CodSesion', 3, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'compras', 'NumEntradas', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'compras', 'PrecioEntradas', 5, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'CodEmple', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Nombre', 2, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Apellidos', 3, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'DNI', 4, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Telefono', 5, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Correo', 6, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Clave', 7, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Jornadas', 8, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'Funcion', 9, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'empleado', 'DescripcionPuesto', 10, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'nomina', 'Cantidad', 1, NULL, 'NO', 'double', NULL, NULL, 22, NULL, NULL, NULL, 'double', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'nomina', 'DNI', 2, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'nomina', 'CodNomina', 3, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'pelicula', 'Nombre', 1, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'pelicula', 'CodPelicula', 2, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'pelicula', 'TotalVendidas', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'peticion', 'CodPeticion', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'peticion', 'MotivoPeticion', 2, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'peticion', 'Estado', 3, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'peticion', 'Revisado', 4, '0', 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'peticion', 'DNIEmple', 5, NULL, 'NO', 'varchar', 9, 27, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(9)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'sesion', 'CodSesion', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'sesion', 'NumSala', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'sesion', 'Hora', 3, NULL, 'NO', 'time', NULL, NULL, NULL, NULL, NULL, NULL, 'time', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'sesion', 'numButacasTotal', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'sesion', 'CodPelicula', 5, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'usuario', 'CodUsuario', 1, NULL, 'NO', 'varchar', 6, 18, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(6)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'usuario', 'Correo', 2, NULL, 'NO', 'varchar', 30, 90, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(30)', 'UNI', '', 'select,insert,update,references', ''),
('def', 'bbddcine', 'usuario', 'Clave', 3, NULL, 'NO', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_spanish2_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
...
('COM_SHOW_TABLE_STATUS', '140'),
('COM_SHOW_TABLES', '33'),
('COM_SHOW_TRIGGERS', '20'),
('COM_SHOW_VARIABLES', '124'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '58'),
('HANDLER_READ_FIRST', '167'),
('HANDLER_READ_KEY', '196'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '271'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '11782'),
('HANDLER_ROLLBACK', '4'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '18'),
('HANDLER_WRITE', '11181'),
('INNODB_BUFFER_POOL_PAGES_DATA', '293'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '528'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7898'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '9796'),
('INNODB_BUFFER_POOL_READS', '259'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2127'),
('INNODB_DATA_FSYNCS', '171'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6426624'),
('INNODB_DATA_READS', '269'),
('INNODB_DATA_WRITES', '412'),
('INNODB_DATA_WRITTEN', '8826880'),
('INNODB_DBLWR_PAGES_WRITTEN', '264'),
('INNODB_DBLWR_WRITES', '23'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '254'),
('INNODB_LOG_WRITES', '104'),
('INNODB_OS_LOG_FSYNCS', '124'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '165888'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '35'),
('INNODB_PAGES_READ', '258'),
('INNODB_PAGES_WRITTEN', '264'),
...
('INNODB_ROWS_INSERTED', '31'),
('INNODB_ROWS_READ', '395'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '2915'),
('UPTIME_SINCE_FLUSH_STATUS', '2915');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Win7_1TB.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Win7_1TB.log'),
('FLUSH_TIME', '1800'),
...
('SYSTEM_TIME_ZONE', 'Hora de verano centroeuropea'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\Win7_1TB-slow.log'),
...
('def', 'agenda', 'PRIMARY', 'def', 'agenda', 'alumnos', 'dni', 1, NULL, NULL, NULL, NULL),
('def', 'agenda', 'alumnos_ibfk_1', 'def', 'agenda', 'alumnos', 'curso', 1, 1, 'agenda', 'cursos', 'curso'),
('def', 'agenda', 'PRIMARY', 'def', 'agenda', 'contactos', 'telefono', 1, NULL, NULL, NULL, NULL),
('def', 'agenda', 'PRIMARY', 'def', 'agenda', 'cursos', 'curso', 1, NULL, NULL, NULL, NULL),
('def', 'agenda', 'PRIMARY', 'def', 'agenda', 'tutores', 'dni', 1, NULL, NULL, NULL, NULL),
('def', 'agenda', 'tutores_ibfk_1', 'def', 'agenda', 'tutores', 'curso', 1, 1, 'agenda', 'cursos', 'curso'),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'cliente', 'CodCliente', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'compras', 'CodCompra', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'compras_ibfk_1', 'def', 'bbddcine', 'compras', 'CodCliente', 1, 1, 'bbddcine', 'cliente', 'CodCliente'),
('def', 'bbddcine', 'compras_ibfk_2', 'def', 'bbddcine', 'compras', 'CodSesion', 1, 1, 'bbddcine', 'sesion', 'CodSesion'),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'empleado', 'DNI', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'Correo', 'def', 'bbddcine', 'empleado', 'Correo', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'nomina', 'CodNomina', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'nomina_ibfk_1', 'def', 'bbddcine', 'nomina', 'DNI', 1, 1, 'bbddcine', 'empleado', 'DNI'),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'pelicula', 'CodPelicula', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'peticion', 'CodPeticion', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'peticion_ibfk_1', 'def', 'bbddcine', 'peticion', 'DNIEmple', 1, 1, 'bbddcine', 'empleado', 'DNI'),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'sesion', 'CodSesion', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'sesion_ibfk_1', 'def', 'bbddcine', 'sesion', 'CodPelicula', 1, 1, 'bbddcine', 'pelicula', 'CodPelicula'),
('def', 'bbddcine', 'PRIMARY', 'def', 'bbddcine', 'usuario', 'CodUsuario', 1, NULL, NULL, NULL, NULL),
('def', 'bbddcine', 'Correo', 'def', 'bbddcine', 'usuario', 'Correo', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2017-05-31 07:29:44', NULL, NULL, NULL, '', '', NULL),
('def', 'agenda', 'alumnos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 7340032, '2017-05-11 08:54:05', NULL, NULL, NULL, '', '', NULL),
('def', 'agenda', 'contactos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 7340032, '2017-05-10 07:33:16', NULL, NULL, NULL, '', '', NULL),
('def', 'agenda', 'cursos', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 7340032, '2017-05-11 08:54:05', NULL, NULL, NULL, '', '', NULL),
('def', 'agenda', 'tutores', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 16384, 7340032, '2017-05-11 08:54:05', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'cliente', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'compras', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 3276, 16384, NULL, 32768, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'empleado', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'nomina', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'pelicula', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'peticion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 16384, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'sesion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 16384, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'bbddcine', 'usuario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 4096, 16384, NULL, 16384, 7340032, '2017-05-31 07:22:46', NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'columns_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 227994731135631359, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 440, 2200, 123848989752688639, 5120, 0, '2012-04-19 14:02:39', '2017-05-18 07:57:57', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'func', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 162974011515469823, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'general_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_category', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 38, 581, 22078, 163536961468891135, 3072, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_keyword', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 465, 197, 91605, 55450570411999231, 16384, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_relation', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1029, 9, 9261, 2533274790395903, 19456, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'help_topic', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 508, 875, 444876, 281474976710655, 20480, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'host', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 110056715893866495, 2048, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'ndb_binlog_index', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'plugin', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'procs_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239253730204057599, 4096, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, '', '', NULL),
('def', 'mysql', 'servers', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 433752939111120895, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'slow_log', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL, NULL, '', '', NULL),
('def', 'mysql', 'tables_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 239535205180768255, 4096, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 1970324836974591, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_leap_second', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 3659174697238527, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_name', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 55450570411999231, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 4785074604081151, 1024, 0, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'time_zone_transition_type', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 10696049115004927, 1024, 0, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, NULL, '', '', NULL),
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 72, 504, 281474976710655, 2048, 0, '2012-04-19 14:02:39', '2017-05-29 07:37:02', NULL, NULL, '', '', NULL),
...
(206, 'root', 'localhost:49732', 'bbddcine', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'agenda', 'alumnos_ibfk_1', 'def', 'agenda', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'alumnos', 'cursos'),
('def', 'agenda', 'tutores_ibfk_1', 'def', 'agenda', 'PRIMARY', 'NONE', 'RESTRICT', 'RESTRICT', 'tutores', 'cursos'),
('def', 'bbddcine', 'compras_ibfk_1', 'def', 'bbddcine', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'compras', 'cliente'),
('def', 'bbddcine', 'compras_ibfk_2', 'def', 'bbddcine', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'compras', 'sesion'),
('def', 'bbddcine', 'nomina_ibfk_1', 'def', 'bbddcine', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'nomina', 'empleado'),
('def', 'bbddcine', 'peticion_ibfk_1', 'def', 'bbddcine', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'peticion', 'empleado'),
('def', 'bbddcine', 'sesion_ibfk_1', 'def', 'bbddcine', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'sesion', 'pelicula');
...
('def', 'agenda', 'utf8', 'utf8_general_ci', NULL),
('def', 'bbddcine', 'utf8', 'utf8_spanish_ci', NULL),
...
('''RosaRoot''@''localhost''', 'def', 'agenda', 'SELECT', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'INSERT', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'UPDATE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'DELETE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'CREATE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'DROP', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'REFERENCES', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'INDEX', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'ALTER', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'CREATE TEMPORARY TABLES', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'LOCK TABLES', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'EXECUTE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'CREATE VIEW', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'SHOW VIEW', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'CREATE ROUTINE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'ALTER ROUTINE', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'EVENT', 'NO'),
('''RosaRoot''@''localhost''', 'def', 'agenda', 'TRIGGER', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'SELECT', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'INSERT', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'UPDATE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'DELETE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'CREATE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'DROP', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'REFERENCES', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'INDEX', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'ALTER', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'CREATE TEMPORARY TABLES', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'LOCK TABLES', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'EXECUTE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'CREATE VIEW', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'SHOW VIEW', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'CREATE ROUTINE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'ALTER ROUTINE', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'EVENT', 'NO'),
('''admin''@''localhost''', 'def', 'netcine', 'TRIGGER', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'SELECT', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'INSERT', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'UPDATE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'DELETE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'CREATE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'DROP', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'REFERENCES', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'INDEX', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'ALTER', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'CREATE TEMPORARY TABLES', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'LOCK TABLES', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'EXECUTE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'CREATE VIEW', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'SHOW VIEW', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'CREATE ROUTINE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'ALTER ROUTINE', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'EVENT', 'NO'),
('''diego''@''localhost''', 'def', 'netcine', 'TRIGGER', 'NO'),
('''''@''%''', 'def', 'test', 'SELECT', 'NO'),
('''''@''%''', 'def', 'test', 'INSERT', 'NO'),
('''''@''%''', 'def', 'test', 'UPDATE', 'NO'),
('''''@''%''', 'def', 'test', 'DELETE', 'NO'),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '10237'),
('INNODB_BUFFER_POOL_READS', '259'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '2127'),
('INNODB_DATA_FSYNCS', '171'),
...
('def', 'agenda', 'alumnos', 0, 'agenda', 'PRIMARY', 1, 'dni', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'agenda', 'alumnos', 1, 'agenda', 'curso', 1, 'curso', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'agenda', 'contactos', 0, 'agenda', 'PRIMARY', 1, 'telefono', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'agenda', 'cursos', 0, 'agenda', 'PRIMARY', 1, 'curso', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'agenda', 'tutores', 0, 'agenda', 'PRIMARY', 1, 'dni', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'agenda', 'tutores', 1, 'agenda', 'curso', 1, 'curso', 'A', 1, NULL, NULL, 'YES', 'BTREE', '', ''),
('def', 'bbddcine', 'cliente', 0, 'bbddcine', 'PRIMARY', 1, 'CodCliente', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'compras', 0, 'bbddcine', 'PRIMARY', 1, 'CodCompra', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'compras', 1, 'bbddcine', 'CodCliente', 1, 'CodCliente', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'compras', 1, 'bbddcine', 'CodSesion', 1, 'CodSesion', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'empleado', 0, 'bbddcine', 'PRIMARY', 1, 'DNI', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'empleado', 0, 'bbddcine', 'Correo', 1, 'Correo', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'nomina', 0, 'bbddcine', 'PRIMARY', 1, 'CodNomina', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'nomina', 1, 'bbddcine', 'DNI', 1, 'DNI', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'pelicula', 0, 'bbddcine', 'PRIMARY', 1, 'CodPelicula', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'peticion', 0, 'bbddcine', 'PRIMARY', 1, 'CodPeticion', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'peticion', 1, 'bbddcine', 'DNIEmple', 1, 'DNIEmple', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'sesion', 0, 'bbddcine', 'PRIMARY', 1, 'CodSesion', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'sesion', 1, 'bbddcine', 'CodPelicula', 1, 'CodPelicula', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'usuario', 0, 'bbddcine', 'PRIMARY', 1, 'CodUsuario', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
('def', 'bbddcine', 'usuario', 0, 'bbddcine', 'Correo', 1, 'Correo', 'A', 4, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'db', 0, 'mysql', 'PRIMARY', 3, 'User', 'A', 5, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mysql', 'db', 1, 'mysql', 'User', 1, 'User', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2017-05-31 07:29:44', '2017-05-31 07:29:44', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2017-05-31 07:29:44', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'agenda', 'alumnos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 7340032, NULL, '2017-05-11 08:54:05', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'agenda', 'contactos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 7340032, NULL, '2017-05-10 07:33:16', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'agenda', 'cursos', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 7340032, NULL, '2017-05-11 08:54:05', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'agenda', 'tutores', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 16384, 7340032, NULL, '2017-05-11 08:54:05', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'bbddcine', 'cliente', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'compras', 'BASE TABLE', 'InnoDB', 10, 'Compact', 5, 3276, 16384, 0, 32768, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'empleado', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'nomina', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'pelicula', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'peticion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 16384, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'sesion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 16384, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'bbddcine', 'usuario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 4, 4096, 16384, 0, 16384, 7340032, NULL, '2017-05-31 07:22:46', NULL, NULL, 'utf8_spanish2_ci', NULL, '', ''),
('def', 'mysql', 'columns_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 227994731135631359, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_bin', NULL, '', 'Column privileges'),
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 5, 440, 2200, 123848989752688639, 5120, 0, NULL, '2012-04-19 14:02:39', '2017-05-18 07:57:57', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Events'),
('def', 'mysql', 'func', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 162974011515469823, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_bin', NULL, '', 'User defined functions'),
('def', 'mysql', 'general_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'General log'),
('def', 'mysql', 'help_category', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 38, 581, 22078, 163536961468891135, 3072, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'help categories'),
('def', 'mysql', 'help_keyword', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 465, 197, 91605, 55450570411999231, 16384, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'help keywords'),
('def', 'mysql', 'help_relation', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1029, 9, 9261, 2533274790395903, 19456, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'keyword-topic relation'),
('def', 'mysql', 'help_topic', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 508, 875, 444876, 281474976710655, 20480, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'help topics'),
('def', 'mysql', 'host', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 110056715893866495, 2048, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_bin', NULL, '', 'Host privileges;  Merged with database privileges'),
('def', 'mysql', 'ndb_binlog_index', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mysql', 'plugin', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL plugins'),
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
('def', 'mysql', 'procs_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239253730204057599, 4096, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'utf8_bin', NULL, '', 'Procedure privileges'),
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', '2012-04-19 14:02:40', 'utf8_bin', NULL, '', 'User proxy privileges'),
('def', 'mysql', 'servers', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 433752939111120895, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'MySQL Foreign Servers table'),
('def', 'mysql', 'slow_log', 'BASE TABLE', 'CSV', 10, 'Dynamic', 2, 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 'utf8_general_ci', NULL, '', 'Slow log'),
('def', 'mysql', 'tables_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 239535205180768255, 4096, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_bin', NULL, '', 'Table privileges'),
('def', 'mysql', 'time_zone', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 1970324836974591, 1024, 0, 1, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zones'),
('def', 'mysql', 'time_zone_leap_second', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 3659174697238527, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Leap seconds information for time zones'),
('def', 'mysql', 'time_zone_name', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 55450570411999231, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone names'),
('def', 'mysql', 'time_zone_transition', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 4785074604081151, 1024, 0, NULL, '2012-04-19 14:02:39', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transitions'),
('def', 'mysql', 'time_zone_transition_type', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 0, 0, 0, 10696049115004927, 1024, 0, NULL, '2012-04-19 14:02:40', '2012-04-19 14:02:40', NULL, 'utf8_general_ci', NULL, '', 'Time zone transition types'),
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 7, 72, 504, 281474976710655, 2048, 0, NULL, '2012-04-19 14:02:39', '2017-05-29 07:37:02', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
...
('def', 'agenda', 'PRIMARY', 'agenda', 'alumnos', 'PRIMARY KEY'),
('def', 'agenda', 'alumnos_ibfk_1', 'agenda', 'alumnos', 'FOREIGN KEY'),
('def', 'agenda', 'PRIMARY', 'agenda', 'contactos', 'PRIMARY KEY'),
('def', 'agenda', 'PRIMARY', 'agenda', 'cursos', 'PRIMARY KEY'),
('def', 'agenda', 'PRIMARY', 'agenda', 'tutores', 'PRIMARY KEY'),
('def', 'agenda', 'tutores_ibfk_1', 'agenda', 'tutores', 'FOREIGN KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'cliente', 'PRIMARY KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'compras', 'PRIMARY KEY'),
('def', 'bbddcine', 'compras_ibfk_1', 'bbddcine', 'compras', 'FOREIGN KEY'),
('def', 'bbddcine', 'compras_ibfk_2', 'bbddcine', 'compras', 'FOREIGN KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'empleado', 'PRIMARY KEY'),
('def', 'bbddcine', 'Correo', 'bbddcine', 'empleado', 'UNIQUE'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'nomina', 'PRIMARY KEY'),
('def', 'bbddcine', 'nomina_ibfk_1', 'bbddcine', 'nomina', 'FOREIGN KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'pelicula', 'PRIMARY KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'peticion', 'PRIMARY KEY'),
('def', 'bbddcine', 'peticion_ibfk_1', 'bbddcine', 'peticion', 'FOREIGN KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'sesion', 'PRIMARY KEY'),
('def', 'bbddcine', 'sesion_ibfk_1', 'bbddcine', 'sesion', 'FOREIGN KEY'),
('def', 'bbddcine', 'PRIMARY', 'bbddcine', 'usuario', 'PRIMARY KEY'),
('def', 'bbddcine', 'Correo', 'bbddcine', 'usuario', 'UNIQUE'),
...
('''RosaRoot''@''localhost''', 'def', 'USAGE', 'NO'),
('''admin''@''localhost''', 'def', 'USAGE', 'NO'),
('''diego''@''localhost''', 'def', 'SELECT', 'YES'),
('''diego''@''localhost''', 'def', 'INSERT', 'YES'),
('''diego''@''localhost''', 'def', 'UPDATE', 'YES'),
('''diego''@''localhost''', 'def', 'DELETE', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE', 'YES'),
('''diego''@''localhost''', 'def', 'DROP', 'YES'),
('''diego''@''localhost''', 'def', 'RELOAD', 'YES'),
('''diego''@''localhost''', 'def', 'SHUTDOWN', 'YES'),
('''diego''@''localhost''', 'def', 'PROCESS', 'YES'),
('''diego''@''localhost''', 'def', 'FILE', 'YES'),
('''diego''@''localhost''', 'def', 'REFERENCES', 'YES'),
('''diego''@''localhost''', 'def', 'INDEX', 'YES'),
('''diego''@''localhost''', 'def', 'ALTER', 'YES'),
('''diego''@''localhost''', 'def', 'SHOW DATABASES', 'YES'),
('''diego''@''localhost''', 'def', 'SUPER', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE TEMPORARY TABLES', 'YES'),
('''diego''@''localhost''', 'def', 'LOCK TABLES', 'YES'),
('''diego''@''localhost''', 'def', 'EXECUTE', 'YES'),
('''diego''@''localhost''', 'def', 'REPLICATION SLAVE', 'YES'),
('''diego''@''localhost''', 'def', 'REPLICATION CLIENT', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE VIEW', 'YES'),
('''diego''@''localhost''', 'def', 'SHOW VIEW', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE ROUTINE', 'YES'),
('''diego''@''localhost''', 'def', 'ALTER ROUTINE', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE USER', 'YES'),
('''diego''@''localhost''', 'def', 'EVENT', 'YES'),
('''diego''@''localhost''', 'def', 'TRIGGER', 'YES'),
('''diego''@''localhost''', 'def', 'CREATE TABLESPACE', 'YES'),
...
--
-- Volcado de datos para la tabla `INNODB_CMP_RESET`
--
...
--
-- Volcado de datos para la tabla `INNODB_CMPMEM_RESET`
--
...
--
-- Volcado de datos para la tabla `INNODB_CMPMEM`
--
...
--
-- Volcado de datos para la tabla `INNODB_CMP`
--
...
('localhost', 'agenda', 'RosaRoot', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'netcine', 'admin', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y'),
('localhost', 'netcine', 'diego', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'N', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
...
--
-- Volcado de datos para la tabla `help_category`
--
...
--
-- Volcado de datos para la tabla `help_keyword`
--
...
--
-- Volcado de datos para la tabla `help_relation`
--
...
--
-- Estructura de tabla para la tabla `proxies_priv`
--
...
('localhost', 'RosaRoot', '*EB58F2C9E5788A234810238E4C0F77263CCC456B', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'admin', '*EB58F2C9E5788A234810238E4C0F77263CCC456B', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', 'N', '', '', '', '', 0, 0, 0, 0, '', NULL),
('localhost', 'diego', '*EB58F2C9E5788A234810238E4C0F77263CCC456B', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', '', '', '', '', 0, 0, 0, 0, '', NULL);
--
-- Base de datos: `performance_schema`
--
...
--
-- Estructura de tabla para la tabla `cond_instances`
--
...
--
-- Estructura de tabla para la tabla `events_waits_current`
--
...
--
-- Estructura de tabla para la tabla `events_waits_history`
--
...
--
-- Estructura de tabla para la tabla `events_waits_history_long`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_by_instance`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_by_thread_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `events_waits_summary_global_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `file_instances`
--
...
--
-- Estructura de tabla para la tabla `file_summary_by_event_name`
--
...
--
-- Estructura de tabla para la tabla `file_summary_by_instance`
--
...
--
-- Estructura de tabla para la tabla `mutex_instances`
--
...
--
-- Estructura de tabla para la tabla `performance_timers`
--
...
--
-- Volcado de datos para la tabla `performance_timers`
--
...
--
-- Estructura de tabla para la tabla `rwlock_instances`
--
...
--
-- Estructura de tabla para la tabla `setup_consumers`
--
...
--
-- Volcado de datos para la tabla `setup_consumers`
--
...
--
-- Estructura de tabla para la tabla `setup_instruments`
--
...
--
-- Estructura de tabla para la tabla `setup_timers`
--
...
--
-- Volcado de datos para la tabla `setup_timers`
--
